...
# Cleaning up/manipulating data and adding new columns
...
def box_plot(season):
	...
	g_box = df[(df['Season']==season) & (df['Make or Miss']=='Make')].groupby(['Month','Date'])['Points'].sum()
	...
	fig_box.savefig('/Users/raghavpaliwal/Documents/NBA Analysis/KB_05_06_boxplot.pdf')
...
def heatmap():
	...
	fig_hm.savefig('/Users/raghavpaliwal/Documents/NBA Analysis/KB_heatmap.pdf')
